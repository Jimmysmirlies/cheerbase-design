...
import { Select, SelectContent, SelectItem, SelectSeparator, SelectTrigger, SelectValue } from "@workspace/ui/shadcn/select";

export type GlassSelectOption = { value: string; label: ReactNode } | { type: "separator" };
