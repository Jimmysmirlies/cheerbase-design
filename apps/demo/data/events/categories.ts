...
export const eventCategories: EventCategory[] = [
  ...
  },
  {
    ...
    events: [
      ...
      {
        id: "fall-classic",
        name: "Fall Classic Showcase",
        organizer: "East Region Events",
        type: "Friendly Competition",
        date: "Nov 22, 2025",
        registrationEnabled: true,
        registrationStartDate: getRegistrationStartDate("Nov 22, 2025"),
        registrationDeadline: getRegistrationDeadline("Nov 22, 2025"),
        earlyBirdEnabled: true,
        earlyBirdStartDate: getRegistrationStartDate("Nov 22, 2025"),
        earlyBirdDeadline: "2025-09-22",
        ...
        description:
          "Autumn showcase featuring panel feedback sessions, warm-up rotations, and post-competition meet-and-greets with judges.",
        tags: ["Fall Series"],
        gallery: getLocalGalleryImages("atlantic-showdown"),
        availableDivisions: [
          {
            name: eventDivisionNames.worlds,
            earlyBird: { price: 105, deadline: "2025-09-22" },
            regular: { price: 125 },
          },
          {
            name: eventDivisionNames.prepNovice,
            earlyBird: { price: 48, deadline: "2025-09-22" },
            regular: { price: 65 },
          },
        ],
      },
      {
        id: "holiday-invitational",
        name: "Holiday Invitational",
        organizer: "Spirit Sports Co.",
        type: "Championship",
        date: "Dec 10, 2025",
        registrationEnabled: true,
        registrationStartDate: getRegistrationStartDate("Dec 10, 2025"),
        registrationDeadline: getRegistrationDeadline("Dec 10, 2025"),
        earlyBirdEnabled: true,
        earlyBirdStartDate: getRegistrationStartDate("Dec 10, 2025"),
        earlyBirdDeadline: "2025-10-10",
        location: "Orlando Convention Center, FL",
        teams: "28 / 40 teams",
        image: getLocalEventImage("spring-regional"),
        slots: {
          filled: 28,
          capacity: 40,
          statusLabel: "Holiday favorite",
        },
        description:
          "Festive championship featuring holiday-themed production, family activities, and optional theme park packages.",
        tags: ["Holiday Series"],
        gallery: getLocalGalleryImages("spring-regional"),
        availableDivisions: [
          {
            name: eventDivisionNames.worlds,
            earlyBird: { price: 115, deadline: "2025-10-10" },
            regular: { price: 135 },
          },
          {
            name: eventDivisionNames.prepNovice,
            earlyBird: { price: 52, deadline: "2025-10-10" },
            regular: { price: 70 },
          },
        ],
      },
      {
        ...
        date: "Dec 21, 2025",
        registrationEnabled: true,
        registrationStartDate: getRegistrationStartDate("Dec 21, 2025"),
        registrationDeadline: getRegistrationDeadline("Dec 21, 2025"),
        earlyBirdEnabled: true,
        earlyBirdStartDate: getRegistrationStartDate("Dec 21, 2025"),
        earlyBirdDeadline: "2025-10-21",
        ...
        description:
          "Pre-holiday showcase with climate-controlled facilities, video replay stations, and coaches hospitality suite.",
        tags: ["Winter Series"],
        gallery: getLocalGalleryImages("metro-finals"),
        availableDivisions: [
          {
            name: eventDivisionNames.worlds,
            earlyBird: { price: 100, deadline: "2025-10-21" },
            regular: { price: 120 },
          },
          {
            name: eventDivisionNames.prepNovice,
            earlyBird: { price: 45, deadline: "2025-10-21" },
            regular: { price: 62 },
          },
        ],
      },
      {
        ...
        date: "Jan 25, 2026",
        registrationEnabled: true,
        registrationStartDate: getRegistrationStartDate("Jan 25, 2026"),
        registrationDeadline: getRegistrationDeadline("Jan 25, 2026"),
        earlyBirdEnabled: true,
        earlyBirdStartDate: getRegistrationStartDate("Jan 25, 2026"),
        earlyBirdDeadline: "2025-11-25",
        ...
        description:
          "Season kickoff event with new year celebrations, goal-setting workshops, and team bonding activities.",
        tags: ["New Year Series"],
        gallery: getLocalGalleryImages("summer-series"),
        availableDivisions: [
          {
            name: eventDivisionNames.worlds,
            earlyBird: { price: 102, deadline: "2025-11-25" },
            regular: { price: 122 },
          },
          {
            name: eventDivisionNames.prepNovice,
            earlyBird: { price: 46, deadline: "2025-11-25" },
            regular: { price: 64 },
          },
        ],
      },
      {
        ...
        date: "Feb 10, 2026",
        registrationEnabled: true,
        registrationStartDate: getRegistrationStartDate("Feb 10, 2026"),
        registrationDeadline: getRegistrationDeadline("Feb 10, 2026"),
        earlyBirdEnabled: true,
        earlyBirdStartDate: getRegistrationStartDate("Feb 10, 2026"),
        earlyBirdDeadline: "2025-12-10",
        ...
        slots: {
          filled: 26,
          capacity: 40,
          statusLabel: "Mountain region favorite",
        },
        description:
          "Rocky Mountain championship featuring alpine-themed production, ski resort partnerships, and après-cheer celebrations.",
        tags: ["Winter Championship"],
        gallery: getLocalGalleryImages("pacific-prestige"),
        availableDivisions: [
          {
            name: eventDivisionNames.worlds,
            earlyBird: { price: 110, deadline: "2025-12-10" },
            regular: { price: 130 },
          },
          {
            name: eventDivisionNames.prepNovice,
            earlyBird: { price: 50, deadline: "2025-12-10" },
            regular: { price: 68 },
          },
        ],
      },
      {
        ...
        date: "Feb 24, 2026",
        registrationEnabled: true,
        registrationStartDate: getRegistrationStartDate("Feb 24, 2026"),
        registrationDeadline: getRegistrationDeadline("Feb 24, 2026"),
        earlyBirdEnabled: true,
        earlyBirdStartDate: getRegistrationStartDate("Feb 24, 2026"),
        earlyBirdDeadline: "2025-12-24",
        ...
        description:
          "Winter wonderland event with heated indoor facilities, hot beverage stations, and cozy spectator lounges.",
        tags: ["Winter Series"],
        gallery: getLocalGalleryImages("metro-finals"),
        availableDivisions: [
          {
            name: eventDivisionNames.worlds,
            earlyBird: { price: 98, deadline: "2025-12-24" },
            regular: { price: 118 },
          },
          {
            name: eventDivisionNames.prepNovice,
            earlyBird: { price: 44, deadline: "2025-12-24" },
            regular: { price: 60 },
          },
        ],
      },
      {
        ...
        description:
          "Spring showcase in the heart of LA with celebrity appearances, red carpet arrivals, and Hollywood production values.",
        tags: ["Spring Series"],
        gallery: getLocalGalleryImages("pacific-prestige"),
        availableDivisions: [
          {
            name: eventDivisionNames.worlds,
            earlyBird: { price: 108, deadline: "2026-02-19" },
            regular: { price: 128 },
          },
          {
            name: eventDivisionNames.prepNovice,
            earlyBird: { price: 50, deadline: "2026-02-19" },
            regular: { price: 68 },
          },
        ],
      },
      {
        ...
        date: "May 04, 2026",
        registrationEnabled: true,
        registrationStartDate: getRegistrationStartDate("May 04, 2026"),
        registrationDeadline: getRegistrationDeadline("May 04, 2026"),
        earlyBirdEnabled: true,
        earlyBirdStartDate: getRegistrationStartDate("May 04, 2026"),
        earlyBirdDeadline: "2026-03-04",
        ...
        slots: {
          filled: 36,
          capacity: 50,
          statusLabel: "Season finale",
        },
        description:
          "Grand finale championship crowning season champions with awards gala, highlight reels, and next-season announcements.",
        tags: ["Season Finale", "Championship"],
        gallery: getLocalGalleryImages("national-championship"),
        availableDivisions: [
          {
            name: eventDivisionNames.worlds,
            earlyBird: { price: 125, deadline: "2026-03-04" },
            regular: { price: 145 },
          },
          {
            name: eventDivisionNames.prepNovice,
            earlyBird: { price: 58, deadline: "2026-03-04" },
            regular: { price: 78 },
          },
        ],
      },
      {
        id: "may-masters",
        name: "May Masters Invite",
        organizer: "West Coast Cheer",
        type: "Friendly Competition",
        date: "May 18, 2026",
        registrationEnabled: true,
        registrationStartDate: getRegistrationStartDate("May 18, 2026"),
        registrationDeadline: getRegistrationDeadline("May 18, 2026"),
        earlyBirdEnabled: true,
        earlyBirdStartDate: getRegistrationStartDate("May 18, 2026"),
        earlyBirdDeadline: "2026-03-18",
        ...
        description:
          "Pacific Northwest invitational featuring local coffee culture, outdoor warm-up spaces, and mountain views.",
        tags: ["Spring Invitational"],
        gallery: getLocalGalleryImages("pacific-prestige"),
        availableDivisions: [
          {
            name: eventDivisionNames.worlds,
            earlyBird: { price: 105, deadline: "2026-03-18" },
            regular: { price: 125 },
          },
          {
            name: eventDivisionNames.prepNovice,
            earlyBird: { price: 48, deadline: "2026-03-18" },
            regular: { price: 66 },
          },
        ],
      },
