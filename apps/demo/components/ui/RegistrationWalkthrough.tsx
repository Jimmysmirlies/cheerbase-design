...
export const WALKTHROUGH_STEPS = [
  {
    ...
    description:
      "Let's walk through registering for an event. First, log in as a Club Owner to access your dashboard.",
  ...
  },
  {
    ...
    title: "Find an Event",
    description:
      "Browse upcoming events and find one you'd like to register for.",
  ...
  },
  {
    ...
    description:
      "Ready to register your teams? Click the registration button to begin.",
  ...
  },
  {
    ...
    description:
      "Select a division and add your team to the registration. You can register multiple teams at once.",
  ...
  },
  {
    ...
    description:
      "Review your teams and the invoice summary. When ready, submit your registration.",
  ...
  },
  {
    ...
    description:
      "Your registration is confirmed. View your registration details to see your teams and invoice.",
  ...
  },
  {
    ...
    description:
      "View your invoice and complete payment to finalize your registration.",
  ...
  },
  {
    ...
    title: "All Done! 🎉",
    description:
      "You've completed the registration walkthrough. You're now ready to register for any event on Cheerbase!",
    action: "",
    page: "/invoice",
  },
] as const;
...
type WalkthroughContextType = {
  ...
  ) => (typeof WALKTHROUGH_STEPS)[number] | undefined;
};
...
export function useRegistrationWalkthrough() {
  ...
  if (!context) {
    throw new Error(
      "useRegistrationWalkthrough must be used within WalkthroughProvider",
    );
  }
  return context;
}
...
export function WalkthroughProvider({ children }: { children: ReactNode }) {
  ...
  const nextStep = useCallback(() => {
    setState((prev) => {
      const currentIndex = WALKTHROUGH_STEPS.findIndex(
        (s) => s.id === prev.currentStep,
      );
  ...
  const currentStepIndex = WALKTHROUGH_STEPS.findIndex(
