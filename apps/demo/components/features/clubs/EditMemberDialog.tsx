...
import { AlertDialog, AlertDialogAction, AlertDialogCancel, AlertDialogContent, AlertDialogDescription, AlertDialogFooter, AlertDialogHeader, AlertDialogTitle, AlertDialogTrigger } from "@workspace/ui/shadcn/alert-dialog";
...
export default function EditMemberDialog({ person, trigger, onSave, onRemove }: Props) {
          ...
          <div className="flex items-center justify-between">
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    This action cannot be undone. The member will be removed from this team.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
            ...
            <div className="flex gap-2">
              ...
              <Button
                ...
                disabled={!canSubmit}
                onClick={() => {
                  onSave({ ...person, firstName: first, lastName: last, dob, email, phone });
                  setOpen(false);
                }}
              >
                Save
