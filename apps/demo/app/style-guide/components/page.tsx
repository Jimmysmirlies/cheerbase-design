...
const components = [
  {
    name: "Hero",
    description: "Split hero layout pairing long-form messaging with a feature visual. Supports carousel slides.",
    href: "/style-guide/components/hero",
    icon: <BoxIcon className="size-5" />,
  },
  {
    name: "Event Card",
    description: "Marketplace-ready card that surfaces event metadata, pricing, and an action button.",
    href: "/style-guide/components/event-card",
    icon: <CalendarIcon className="size-5" />,
  },
  {
    name: "Organizer Card",
    description: "Compact card for organizer rails and recommendations. Initials auto-generate from name.",
    href: "/style-guide/components/organizer-card",
    icon: <UsersIcon className="size-5" />,
  },
  {
    name: "Quick Filter Rail",
    description: "Pill-based filter controls for top-of-page filtering or dashboard subsets.",
    href: "/style-guide/components/quick-filter-rail",
    icon: <FilterIcon className="size-5" />,
  },
  {
    name: "Organizers Section",
    description: "Reusable section that renders a horizontal organizer rail with CTA and copy.",
    href: "/style-guide/components/organizers-section",
    icon: <LayoutGridIcon className="size-5" />,
  },
  {
    name: "Event Categories Section",
    description: "Grid-based section that lists categories and renders event cards per category.",
        ...
        <div className="space-y-12">
          ...
          <div className="flex flex-col gap-4 px-1">
            ...
            <div className="rounded-2xl border border-border bg-card/60 p-5 text-sm text-muted-foreground">
              Looking for implementation details? Browse the component source in <code className="rounded bg-muted px-1.5 py-0.5">apps/demo/components/ui</code> or port them to the
