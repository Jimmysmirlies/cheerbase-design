...
import { useUnifiedClubData, getRegistrationById } from '@/hooks/useUnifiedClubData'
...
export function OrganizerInvoicePage({ registrationId }: OrganizerInvoicePageProps) {
  ...
  const event = findEventById(registration.eventId)
        ...
        // Back button goes to organizer invoices page
        const registrationHref = '/organizer/invoices'
